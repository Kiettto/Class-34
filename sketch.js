...
function setup() {
  ...
  star1 = createSprite(310, 50, 20, 20);
  star1.addImage(starImg);
  star1.scale = 0.02;

  star2 = createSprite(90, 370, 20, 20);
  ...
  displayStar = createSprite(75,50,20,20);
  displayStar.addAnimation("empty",empty_star);
...
function draw() {
  ...
  if (fruit != null && fruit.position.y >= 650) {
   ...
   if (collide(fruit, star1) == true) {
     star1.visible = false;
     displayStar.changeAnimation("one");
   }

  if (collide(fruit, star2) == true) {
    star2.visible = false;
    displayStar.changeAnimation("two");
  }
